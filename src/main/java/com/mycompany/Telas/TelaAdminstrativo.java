 ...
 * @author eduardo.3946
 */
public class TelaAdminstrativo extends javax.swing.JFrame {

    /**
     * Creates new form Telaadminstrativo
     */
    public TelaAdminstrativo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(514, 233));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAdminstrativo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAdminstrativo().setVisible(true);
            }
        });
    }
