...
CREATE TABLE `endereco` (
  ...
  `Num_Residencial` int DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `endereco` VALUES (1,NULL,NULL,NULL,NULL),(2,NULL,NULL,NULL,NULL),(3,NULL,NULL,NULL,NULL),(4,NULL,NULL,NULL,NULL);
...
CREATE TABLE `matricula` (
  `id` int NOT NULL,
  `id_endereco` int DEFAULT NULL,
  `Crianca` varchar(100) DEFAULT NULL,
  `Pai` varchar(100) DEFAULT NULL,
  `Telefone_pai` varchar(100) DEFAULT NULL,
  `Mae` varchar(100) DEFAULT NULL,
  `telefone_mae` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `matricula_FK` (`id_endereco`),
  CONSTRAINT `matricula_FK` FOREIGN KEY (`id_endereco`) REFERENCES `endereco` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `matricula` VALUES (1,1,'Pedro','Marcos','123456789','Maria','123456789799');
...
-- Dump completed on 2023-11-28 11:48:28
